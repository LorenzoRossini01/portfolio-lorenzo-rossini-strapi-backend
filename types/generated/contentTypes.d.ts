...
export interface ApiAboutMeTextAboutMeText extends Struct.SingleTypeSchema {
  collectionName: 'about_me_texts';
  info: {
    displayName: 'about-me-text';
    pluralName: 'about-me-texts';
    singularName: 'about-me-text';
  };
  options: {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::about-me-text.about-me-text'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiContactMeTextContactMeText extends Struct.SingleTypeSchema {
  collectionName: 'contact_me_texts';
  info: {
    displayName: 'contact-me-text';
    pluralName: 'contact-me-texts';
    singularName: 'contact-me-text';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::contact-me-text.contact-me-text'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiPreviousJobPreviousJob extends Struct.CollectionTypeSchema {
  collectionName: 'previous_jobs';
  info: {
    displayName: 'previous-job';
    pluralName: 'previous-jobs';
    singularName: 'previous-job';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    description_excerpt: Schema.Attribute.Text;
    ...
    publishedAt: Schema.Attribute.DateTime;
    repository_url: Schema.Attribute.String;
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
    tech_skills: Schema.Attribute.Relation<
      'manyToMany',
      'api::tech-skill.tech-skill'
    >;
...
export interface ApiTechSkillTechSkill extends Struct.CollectionTypeSchema {
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::about-me-text.about-me-text': ApiAboutMeTextAboutMeText;
      'api::certification.certification': ApiCertificationCertification;
      'api::contact-me-text.contact-me-text': ApiContactMeTextContactMeText;
      'api::contact-message.contact-message': ApiContactMessageContactMessage;
      'api::education.education': ApiEducationEducation;
      'api::previous-job.previous-job': ApiPreviousJobPreviousJob;
      'api::project.project': ApiProjectProject;
      'api::tech-skill.tech-skill': ApiTechSkillTechSkill;
